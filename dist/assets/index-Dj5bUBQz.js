import{B as n,c as e,e as o,J as p,x as i,a5 as r}from"./index-TzZah-E4.js";var s=function(t){var l=t.dt;return`
.p-floatlabel {
    display: block;
    position: relative;
}
...
`)},b={root:function(t){t.instance;var l=t.props;return["p-floatlabel",{"p-floatlabel-over":l.variant==="over","p-floatlabel-on":l.variant==="on","p-floatlabel-in":l.variant==="in"}]}},f=n.extend({name:"floatlabel",theme:s,classes:b}),c={name:"BaseFloatLabel",extends:r,props:{variant:{type:String,default:"over"}},style:f,provide:function(){return{$pcFloatLabel:this,$parentInstance:this}}},u={name:"FloatLabel",extends:c,inheritAttrs:!1};function d(a,t,l,h,v,m){return e(),o("span",i({class:a.cx("root")},a.ptmi("root")),[p(a.$slots,"default")],16)}u.render=d;export{u as s};
